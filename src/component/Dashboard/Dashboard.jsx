...
const Dashboard = () => {
  return (
    <div className="flex-[0.8] h-screen overflow-auto p-[50px] flex justify-between bg-[whitesmoke] box-border">
      <div className="w-[70%] p-[30px] h-full h-fit box-border bg-[#f4f6fa] rounded-[20px] shadow-[0_10px_20px_rgba(0,0,0,0.2)]"
>
    ...
    <div className="w-full box-border rounded-[30px] px-[20px] py-[15px] shadow-[0_4px_6px_rgba(0,0,0,0.1)] my-[40px] text-[16px] bg-white">
